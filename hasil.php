									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_laptop = mysqli_fetch_array($query)) {
												$Matrik[$no - 1] = array($data_laptop['harga_angka'], $data_laptop['ram_angka'], $data_laptop['memori_angka'], $data_laptop['processor_angka'], $data_laptop['berat_angka']);
											?>
												<tr>
													<td>
													...
													<td>
														<center><?php echo $data_laptop['berat_angka'] ?></center>
													</td>
												</tr>
											<?php
												$no++;
										...
										<tbody>
											...
											while ($data_laptop = mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no - 1] = array(
													...
													$data_laptop['berat_angka'] / $pembagiNM[4]
												);
											...
											?>
												<tr>
													...
													<td>
														<center><?php echo round($data_laptop['harga_angka'] / $pembagiNM[0], 6) ?></center>
													</td>
													<td>
														<center><?php echo round($data_laptop['ram_angka'] / $pembagiNM[1], 6) ?></center>
													</td>
													<td>
														<center><?php echo round($data_laptop['memori_angka'] / $pembagiNM[2], 6) ?></center>
													</td>
													<td>
														<center><?php echo round($data_laptop['processor_angka'] / $pembagiNM[3], 6) ?></center>
													</td>
													<td>
														<center><?php echo round($data_laptop['berat_angka'] / $pembagiNM[4], 6) ?></center>
													</td>
												</tr>
											<?php
												$no++;
									...
									<table class="responsive-table">
										<thead>
											<tr>
												...
												<th>
													<center>Value Kriteria Berat</center>
												</th>
											</tr>
										</thead>
										<tbody>
										...
										<tbody>
											<tr>
												...
												for ($i = 0; $i < count($nilaiV); $i++) {
													if ($nilaiV[$i] == $testmax) {
														$query = mysqli_query($selectdb, "SELECT * FROM data_laptop where id_hp = $i+1");
												?>
														<td>
