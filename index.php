...
<body>
	...
	<div id="index-banner" class="parallax-container">
		<div class="section no-pad-bot">
			<div class="container">
				<h1 class="header jarak center black-text" style="font-size: 34px">SISTEM PENDUKUNG KEPUTUSAN MENGGUNAKAN METODE TOPSIS</h1>
				<div class="row center">
					<h5 class="header jarak-button col s12 black-text" style="margin-bottom: 0px; font-size: 26px">PEMILIHAN LAPTOP</h5>
				</div>
				<div class="row center" \>
		...
		<div class="parallax"><img src="assets/image/pixel.jpg" style="top:2px ;" alt="Laptop"></div>
	</div>
	<!-- Jumbotron End -->
